...
# When resting, if your HP or MP is below this percentage of being full, it will stop resting when this percent of maximum HP or MP is refilled. Resting after this point will still rest up to 100%.
rest_wait_percent = 100

# If true, auto-explore waits until your HP and MP are both at rest_wait_percent before moving. This is always disabled for Meteorans.
...
# Explore will stop for one of these conditions. Whatever you set this option to, anything that stops travel will also stop explore.
...
# Macros #
##########
macros += M \{-1012} ===autoplay
macros += M \{-1018} >
macros += M \{-1016} <
macros += M \{-1015} \{6}@\{-1010}
macros += M z z?
macros += M 1 zaf
macros += M 2 zbf
macros += M 3 zcf
...
# Armour/Weapon autopickup by rwbarton, enhanced by HDA
{
